    ...
    try:
        ...
        style_recommendations = {
            ...
            'formal': [
                ...
                {'title': 'Power Suit', 'description': 'Crisp button-up, tailored trousers, leather shoes', 'styles': ['formal'], 'image': 'https://images.unsplash.com/photo-1516257984-b1b4d707412e?w=600&auto=format&fit=crop'},
            ],
            'sporty': [
